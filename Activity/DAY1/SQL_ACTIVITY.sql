...
INSERT INTO productions(Productionid,Productionname,Address,Dateofstarted, Ownername) VALUES(9091,"Arkamediaworks","Hyderabad",2001,"Shobu Yarlagadda");
INSERT INTO productions(Productionid,Productionname,Address,Dateofstarted, Ownername) VALUES(8892,"Lyca Productions","Chennai",2014,"Subaskaran");
INSERT INTO productions(Productionid,Productionname,Address,Dateofstarted, Ownername) VALUES(1010,"Hari Om Entertainment","Mumbai",2008,"Akshay Kumar");
INSERT INTO productions(Productionid,Productionname,Address,Dateofstarted, Ownername) VALUES(1988,"Red Chillies Entertainment","Mumbai",2003,"Shah Ruck");
INSERT INTO productions(Productionid,Productionname,Address,Dateofstarted, Ownername) VALUES(1899,"Viacom 18 Studios","Mumbai",2008,"Ajit Andhare");
INSERT INTO productions(Productionid,Productionname,Address,Dateofstarted, Ownername) VALUES(7882,"DVV Entertainments","Hyderabad",1993,"DVV Danayya");
INSERT INTO productions(Productionid,Productionname,Address,Dateofstarted, Ownername) VALUES(6773,"Homable Films","Bangalore",1995,"Vijay");
INSERT INTO productions(Productionid,Productionname,Address,Dateofstarted, Ownername) VALUES(7682,"Mythri Movie Makers","Hyderabad",2015,"Naveen Yerneni");
INSERT INTO productions(Productionid,Productionname,Address,Dateofstarted, Ownername) VALUES(1854,"Junglee Pictures","Mumbai",2014,"Vineet Jain");
INSERT INTO productions(Productionid,Productionname,Address,Dateofstarted, Ownername) VALUES(2341,"CRM","Bangalore",2017,"Manohar");
INSERT INTO productions(Productionid,Productionname,Address,Dateofstarted, Ownername) VALUES(1111,"STP","Chennai",2018,"Sree");
...
#4   SELECT Moviename,MIN(Length) as min_length from movie;
...
-------------------------------------------------------------
 #6   SELECT Moviename,Heroname,Heroine, MAX(Length) as max_length from movie;
 #7-----------------------------------------------------------------------------
...
SELECT count(*) FROM movie
   WHERE MONTH(Releaseddate) = '10';
   #13------------------------
   SELECT Moviename,Productionid
FROM movie
WHERE Productionid IN
    (SELECT Productionid FROM movie
